            ...
            <ul class="rooms_list">
                            ...
                            <div class="main_pricing d-flex flex-column align-items-md-end justify-content-md-between">
                                <div class="wrapper d-flex flex-column">
                                    <span class="main_pricing-item">
                                        <span class="h2">5%</span> Offer / 1 night
                                    </span>
                                    <span class="main_pricing-item">
                    ...
                    <div class="item-wrapper d-md-flex">
                        ...
                        <div class="main d-md-flex justify-content-between">
                            ...
                            <div class="main_pricing d-flex flex-column align-items-md-end justify-content-md-between">
                                <div class="wrapper d-flex flex-column">
                                    <span class="main_pricing-item">
                                        <span class="h2">10%</span> Offer / 1 night
                                    </span>
                                    <span class="main_pricing-item">
                ...
                <li class="rooms_list-item" data-order="4" data-aos="fade-up">
                    <div class="item-wrapper d-md-flex">
                        <div class="media">
                            <picture>
                                <!-- <source data-srcset="img/rooms/04.webp" srcset="img/rooms/04.webp"> -->
                                <img class="lazy" data-src="img/rooms/04.jpg" src="img/rooms/04.jpg" alt="media">
                            </picture>
                        </div>
                        <div class="main d-md-flex justify-content-between">
                            <div class="main_info d-md-flex flex-column justify-content-between">
                                <a class="main_title h4" href="javascript:void(0)">Group Room </a>
                                <p class="main_description">
                                    Comfortable group accommodations where shared moments become
                                    cherished memories.
                                </p>
                                <div class="main_amenities">
                                    <span class="main_amenities-item d-inline-flex align-items-center">
                                        <i class="icon-user icon"></i>8 Sleeps
                                    </span>
                                    <span class="main_amenities-item d-inline-flex align-items-center">
                ...
                <li class="rooms_list-item" data-order="5" data-aos="fade-up">
                    <div class="item-wrapper d-md-flex">
                        <div class="media">
                            <picture>
                                <img class="lazy" data-src="img/rooms/05.jpg" src="img/rooms/05.jpg" alt="media">
                            </picture>
                        </div>
                        <div class="main d-md-flex justify-content-between">
                            <div class="main_info d-md-flex flex-column justify-content-between">
                                <a class="main_title h4" href="javascript:void(0)">King Size AC </a>
                                <p class="main_description">
                                    Beat the heat with our roomy and efficient air conditioning.
                                </p>
                                <div class="main_amenities">
                                    <span class="main_amenities-item d-inline-flex align-items-center">
                                        <i class="icon-user icon"></i> 4 Sleeps
                                    </span>
                                    <span class="main_amenities-item d-inline-flex align-items-center">
                            ...
                            <div class="main_pricing d-flex flex-column align-items-md-end justify-content-md-between">
                                <div class="wrapper d-flex flex-column">
                                    ...
                                    <span class="main_pricing-item">
                                        <span class="h2">10%</span> Offer / 1 nights </span>
                                    <span class="main_pricing-item">
                ...
                <li class="rooms_list-item" data-order="1" data-aos="fade-up">
                    <div class="item-wrapper d-md-flex">
                        <div class="media">
                            <picture>
                                <img class="lazy" data-src="img/rooms/01.jpg" src="img/rooms/01.jpg" alt="media">
                            </picture>
                        </div>
                        <div class="main d-md-flex justify-content-between">
                            <div class="main_info d-md-flex flex-column justify-content-between">
                                <a class="main_title h4" href="javascript:void(0)">Standard Non AC - 7 Rooms</a>
                                <p class="main_description">
                                    Your peaceful retreat awaits in our comfortable and serene rooms.
                                </p>
                                <div class="main_amenities">
                                    <span class="main_amenities-item d-inline-flex align-items-center">
                                        <i class="icon-user icon"></i> 2 Sleeps
            ...
            <div class="footer_main d-sm-flex flex-wrap flex-lg-nowrap justify-content-between">
                <div class="footer_main-block footer_main-block--about col-sm-7 col-lg-auto d-flex flex-column">
                    ...
                    <p class="footer_main-block_text">
                        Explore affordably with our budget rooms in trichy. Comfort meets savings in our cozy
                        accommodations.
                        Your perfect stay is just a click away. Book now for an unforgettable experience!
                    </p>
                </div>
