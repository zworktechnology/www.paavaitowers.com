        ...
        })()(
          {
                        ...
                        (function (e) {
                          ...
                          var c = "undefined" != typeof window ? window : e,
                            ...
                            w = function (e) {
                              ...
                              else for (var a in e) n[a] = t[a] || "linear";
                              return n;
                            },
                            b = function (e) {
                              if (e === p)
                                  ...
                                  },
                                  {
                                    ...
                                    value: function () {
                                      ...
                                      (this._targetState = o(
                                        ...
                                        (this._easing = w(y, c));
                                      var S = e.filters;
                                      for (var C in ((this._filters.length = 0),
                                      S))
                                        S[C].doesApply(this) &&
                                          this._filters.push(S[C]);
                                      return (
                        ...
                        var j = new a.a(),
                          ...
                          D = function (e, t, n, i) {
                            var s =
                              ...
                              r = A({}, e),
                              o = Object(a.b)(e, i);
                            for (var l in ((j._filters.length = 0),
                            j.set({}),
                            (j._currentState = r),
                            (j._originalState = e),
                            (j._targetState = t),
                            (j._easing = o),
                            z))
                              z[l].doesApply(j) && j._filters.push(z[l]);
                            j._applyFilter("tweenCreated"),
                              j._applyFilter("beforeTween");
            ...
            6: [
              function (e, t, n) {
                ...
                (a.prototype = new i()),
                  ...
                  (a.prototype._pathString = s.prototype._pathString),
                  (a.prototype._trailString = s.prototype._trailString),
                  (t.exports = a);
              },
                ...
                var i = e("./path"),
                  ...
                  a = function e(t, n) {
                    ...
                    if (0 !== arguments.length) {
                      ...
                      if (!(r = s.isString(t) ? document.querySelector(t) : t))
                      ...
                      (this._container = r),
                        ...
                        this._opts.svgStyle &&
                          s.setStyles(a.svg, this._opts.svgStyle),
                        (this.svg = a.svg),
                        (this.path = a.path),
                        (this.trail = a.trail),
                        (this.text = null);
                      ...
                      (this._progressPath = new i(a.path, o)),
            ...
            9: [
              function (e, t, n) {
                ...
                function o(e, t, n) {
                  for (var s = e.style, r = 0; r < i.length; ++r)
                    s[i[r] + c(t)] = n;
                  s[t] = n;
                }
                function l(e, t) {
    ...
    (() => {
        ...
        n.forEach(function (e) {
          var n = e.getAttribute("id"),
            ...
            a = new (t().Line)("#".concat(n), {
              ...
              from: { color: "#DDEAF6" },
              to: { color: "#235784" },
              text: { value: "0", className: "progress-text" },
              step: function (e, t) {
          ...
          function o() {
            var e;
            (e = i.getBoundingClientRect()).bottom < 0 ||
              e.right < 0 ||
              e.left > window.innerWidth ||
              e.top > window.innerHeight ||
              a.animate(r, { duration: 700 });
          }
        ...
        slideTo: function (e = 0, t = this.params.speed, n = !0, i, s) {
          ...
          if (
            ...
            return (
              ...
              "reset" !== w && (r.transitionStart(n, w), r.transitionEnd(n, w)),
              !1
            );
          if (o.cssMode) {
            const e = r.isHorizontal(),
            ...
            if (0 === t) {
              ...
              if (!r.support.smoothScroll)
                return (
                  E({ swiper: r, targetPosition: n, side: e ? "left" : "top" }),
                  !0
                );
      ...
      function B(e) {
        ...
        if (
          ...
          w(c.target).is(i.focusableElements)
        )
      ...
      class te {
        constructor(...e) {
          ...
          (i.__swiper__ = !0),
            (i.support = P()),
            (i.device = M({ userAgent: n.userAgent })),
            (i.browser = $()),
            (i.eventsListeners = {}),
      ...
      function le() {
        ...
        window.innerWidth < 991.98
          ? e.changeDirection("horizontal")
          : e.changeDirection("vertical");
      }
      ne.use([
        function ({ swiper: e, extendParams: t, on: n, emit: i }) {
          function s(t) {
          ...
          function c() {
            ...
            if (
              ("fraction" === n.type &&
                ...
                c.find(se(n.totalClass)).text(n.formatFractionTotal(u))),
              "progressbar" === n.type)
            ) {
              let t;
          ...
          function u() {
            ...
            0 !== n.length &&
              (e.params.uniqueNavElements &&
                ...
                ((n = e.$el.find(t.el)),
                n.length > 1 &&
                  (n = n.filter((t) => w(t).parents(".swiper")[0] === e.el))),
              "bullets" === t.type &&
                t.clickable &&
          ...
          n("init", () => {
            ...
            n("click", (t, n) => {
              ...
              if (
                ...
                r.length > 0 &&
                !w(s).hasClass(e.params.pagination.bulletClass)
              ) {
                if (
                  e.navigation &&
        ...
        function ({ swiper: e, extendParams: t, on: n, emit: i }) {
          ...
          function p() {
            e.params.autoplay.disableOnInteraction ? o() : c(),
              ["transitionend", "webkitTransitionEnd"].forEach((t) => {
                e.$wrapperEl[0].removeEventListener(t, u);
              });
          }
          ...
          (e.autoplay = { running: !1, paused: !1 }),
            ...
            Object.assign(e.autoplay, { pause: c, run: r, start: a, stop: o });
        },
        ...
        function ({ swiper: e, extendParams: t, on: n }) {
          ...
          function r() {
            ...
            const n = t.clickedIndex,
              i = t.clickedSlide;
            if (i && w(i).hasClass(e.params.thumbs.slideThumbActiveClass))
              return;
            if (null == n) return;
            let s;
            if (
              ((s = t.params.loop
                ? parseInt(
                    w(t.clickedSlide).attr("data-swiper-slide-index"),
                    10
                  )
                : n),
              e.params.loop)
