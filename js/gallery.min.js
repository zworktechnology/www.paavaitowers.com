(() => {
         ...
         */ !(function (s, r) {
          ...
          (i = function () {
            var t,
              ...
              b = null,
              E = function (t) {
                -1 !== t.target.id.indexOf("baguette-img") && F();
              },
              _ = function (t) {
  ...
  (n.n = (t) => {
    ...
    (() => {
      ...
      var g = (function () {
          function t(n, i) {
            e(this, t), (this.x = y(n)), (this.y = y(i));
          }
          return (
            o(t, null, [
              {
      ...
      (w.Css = {
        ...
        (w.Scale = { VISIBLE: 1, HIDDEN: 0.001 });
      var k = null,
        I = function () {
          if (null !== k) return k;
          ...
          return (k = 10 === Math.round(y(n))), t.removeChild(e), k;
        };
      function T(t, e) {
        var n =
      ...
      function D(t) {
        return (
          !!L[t] &&
          (L[t].element.removeEventListener(O, L[t].listener),
          (L[t] = null),
          !0)
        );
      }
      function A(t, e) {
        var n = O + (x += 1),
          i = function (t) {
            t.currentTarget === t.target && (D(n), e(t));
          };
        return (
          t.addEventListener(O, i), (L[n] = { element: t, listener: i }), n
        );
      }
      function M(t) {
      ...
      function P(t, e, n) {
        if (1 === e) return t;
        for (var i = [], o = 0; o <= n - e; o++) i.push(M(t.slice(o, o + e)));
        return i;
      }
      function z(t, e) {
        for (
            ...
            var o,
              s =
                arguments.length > 1 && void 0 !== arguments[1]
                  ...
                  : {};
            e(this, i),
              ((o = n.call(this)).options = Object.assign({}, i.options, s)),
              o.options.delimeter &&
                (o.options.delimiter = o.options.delimeter),
              (o.lastSort = {}),
              (o.group = i.ALL_ITEMS),
              (o.lastFilter = i.ALL_ITEMS),
              (o.isEnabled = !0),
              (o.isDestroyed = !1),
              (o.isInitialized = !1),
              (o._transitions = []),
              ...
              [
                  ...
                  value: function (t) {
                    var e = this.options,
                      ...
                      o = this.options.useTransforms
                        ? ["transform"]
                        : ["top", "left"],
                      s = Object.keys(w.Css.HIDDEN.before).map(function (t) {
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    return Array.from(this.element.children)
                      ...
                      .map(function (e) {
                        return new w(e, t.options.isRTL);
                      });
                  },
                },
                {
                ...
                },
                {
                  ...
                  value: function (t) {
                    ...
                    t.forEach(function (t, o) {
                      function s() {
                        t.applyCss(w.Css.VISIBLE.after);
                      }
                      if (g.equals(t.point, n[o]) && !t.isHidden)
                        return t.applyCss(w.Css.VISIBLE.before), void s();
                      (t.point = n[o]),
                        (t.scale = w.Scale.VISIBLE),
                        (t.isHidden = !1);
                      var r = e.getStylesForTransition(t, w.Css.VISIBLE.before);
                  ...
                  value: function (t) {
                    ...
                    if (this.options.isCentered) {
                      var n = t.map(function (t, n) {
                        var o = i.getSize(t.element, !0),
                          s = e._getItemPosition(o);
                        return new b(s.x, s.y, o.width, o.height, n);
                      });
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    e.forEach(function (e) {
                      function i() {
                        e.applyCss(w.Css.HIDDEN.after);
                      }
                      if (e.isHidden)
                        return e.applyCss(w.Css.HIDDEN.before), void i();
                      (e.scale = w.Scale.HIDDEN), (e.isHidden = !0);
                      var o = t.getStylesForTransition(e, w.Css.HIDDEN.before);
                  ...
                  value: function (t) {
                    var e = this,
                      n = N(t).map(function (t) {
                        return new w(t, e.options.isRTL);
                      });
                    this._initItems(n), this._resetCols();
                    var i = C(this._mergeNewItems(n), this.lastSort),
                      o = this._filter(this.lastFilter, i),
                      s = function (t) {
                        return n.includes(t);
                      },
                      r = function (t) {
                        (t.scale = w.Scale.HIDDEN),
                          (t.isHidden = !0),
                          t.applyCss(w.Css.HIDDEN.before),
                          t.applyCss(w.Css.HIDDEN.after);
                      },
              ...
              [
                {
                  ...
                  value: function (t) {
                    var e =
                      ...
                      o = T(t, "height", n);
                    if (e) {
                      var s = T(t, "marginLeft", n),
                        r = T(t, "marginRight", n),
                        a = T(t, "marginTop", n),
                        l = T(t, "marginBottom", n);
                      (i += s + r), (o += a + l);
                    }
      ...
      (R.ShuffleItem = w),
        (R.ALL_ITEMS = "all"),
        (R.FILTER_ATTRIBUTE_KEY = "groups"),
        (R.EventType = {
          LAYOUT: "shuffle:layout",
          REMOVED: "shuffle:removed",
        }),
        (R.Classes = E),
        (R.FilterMode = { ANY: "any", ALL: "all" }),
        (R.options = {
          group: R.ALL_ITEMS,
          speed: 250,
        ...
        (R.__sorter = C),
        (R.__getColumnSpan = F),
        (R.__getAvailablePositions = P),
        (R.__getShortColumn = z),
        (R.__getCenteredPositions = B);
      const H = R;
      function q(t, e) {
        var n = Object.keys(t);
          ...
          var s = new H(
              ...
              (function (e) {
                for (var n = 1; n < arguments.length; n++) {
                  ...
                  n % 2
                    ? q(Object(i), !0).forEach(function (n) {
                        t(e, n, i[n]);
                      })
            ...
            n
              ? (function (e) {
                  for (var n = 1; n < arguments.length; n++) {
                    var i = null != arguments[n] ? arguments[n] : {};
                    n % 2
                      ? U(Object(i), !0).forEach(function (n) {
                          t(e, n, i[n]);
                        })
                      : Object.getOwnPropertyDescriptors
                      ? Object.defineProperties(
      ...
      document.addEventListener("DOMContentLoaded", function () {
        V(".gallery_masonry", ".gallery_filters-filter", {
          itemSelector: ".gallery_masonry-item",
        }),
          X(".gallery_masonry-item"),
          X(".gallery_grid");
      });
    })();
})();
