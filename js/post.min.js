         ...
         */ !(function (r, a) {
          ...
          (o = function () {
            var e,
              ...
              C = function (e) {
                g.count++,
                  1 < g.count && (g.multitouch = !0),
                  (g.startX = e.changedTouches[0].pageX),
                  (g.startY = e.changedTouches[0].pageY);
              },
              O = function (e) {
                if (!b && !g.multitouch) {
            ...
            function L(i, r) {
              if (d !== i) {
                ...
                for (
                  var a, s = [], c = [], f = (y.length = 0);
                  f < i.length;
                  f++
                )
                  ((a = U("div")).className = "full-image"),
                    (a.id = "baguette-img-" + f),
                    y.push(a),
                    s.push("baguetteBox-figure-" + f),
                    c.push("baguetteBox-figcaption-" + f),
                    t.appendChild(y[f]);
                e.setAttribute("aria-labelledby", s.join(" ")),
            ...
            function S(t) {
              l.noScrollbars &&
                ...
                "block" !== e.style.display &&
                  (z(document, "keydown", N),
                  (g = { count: 0, startX: null, startY: null }),
                  D((f = t), function () {
                    X(f), R(f);
                  }),
                  M(),
                  ...
                  l.onChange && l.onChange(f, y.length),
            ...
            function Y(e, t) {
              return !p && 0 <= e && e < t.length
                ? (L(t, l), S(e), !0)
                : e < 0
                ? (l.animation && q("left"), !1)
                : e >= y.length
                ? (l.animation && q("right"), !1)
                : (D((f = e), function () {
                    X(f), R(f);
                  }),
                  M(),
                ...
                }),
              {
                run: function (l, u) {
                  return (
                    ...
                    (function () {
                      if ((e = V("baguetteBox-overlay")))
                        return (
                          (t = V("baguetteBox-slider")),
                          (n = V("previous-button")),
                          (o = V("next-button")),
                          void (i = V("close-button"))
                        );
                      (e = U("div")).setAttribute("role", "dialog"),
                        (e.id = "baguetteBox-overlay"),
                        document.getElementsByTagName("body")[0].appendChild(e),
                        ((t = U("div")).id = "baguetteBox-slider"),
                        e.appendChild(t),
