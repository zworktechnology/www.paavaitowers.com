    ...
    <header class="page">
        <div class="container">
            <ul class="breadcrumbs d-flex flex-wrap align-content-center">
                ...
                <li class="list-item"><a class="link" href="#">Photo Gallery of Our Rooms</a></li>
            </ul>
        ...
        <div class="gallery section">
            <div class="container">
                ...
                <div class="gallery_masonry row g-0">
                    ...
                    <figure class="gallery_masonry-item col-sm-6 col-lg-4">
                        <a class="aspect" href="img/gallery/full01.jpg" data-role="gallery-link">
                            <div class="aspect__inner">
                                <picture>
                                    <img class="gallery_masonry-item_img lazy" data-src="img/gallery/full01.jpg" src="img/gallery/full01.jpg" alt="media">
                                </picture>
                            </div>
                            <div class="overlay d-flex align-items-center justify-content-center">
                                <div class="overlay_focus"><svg width="105" height="106" viewbox="0 0 105 106" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M103.514 28.944C102.693 28.944 102.028 28.2795 102.028 27.4598V3.712H78.2507C77.43 3.712 76.7646 3.04749 76.7646 2.22777C76.7646 1.40805 77.43 0.74353 78.2507 0.74353H103.514C104.335 0.74353 105 1.40805 105 2.22777V27.4598C105 28.2795 104.335 28.944 103.514 28.944Z" fill="currentColor"></path>
                                        <path d="M26.7492 105.614H1.48607C0.665335 105.614 0 104.95 0 104.13V78.8978C0 78.0781 0.665335 77.4136 1.48607 77.4136C2.3068 77.4136 2.97214 78.0781 2.97214 78.8978V102.646H26.7492C27.57 102.646 28.2353 103.31 28.2353 104.13C28.2353 104.95 27.57 105.614 26.7492 105.614Z" fill="currentColor"></path>
                                        <path d="M1.48607 28.944C0.665335 28.944 0 28.2795 0 27.4598V2.22777C0 1.40805 0.665335 0.74353 1.48607 0.74353H26.7492C27.57 0.74353 28.2353 1.40805 28.2353 2.22777C28.2353 3.04749 27.57 3.712 26.7492 3.712H2.97214V27.4598C2.97214 28.2795 2.3068 28.944 1.48607 28.944Z" fill="currentColor"></path>
                                        <path d="M103.514 105.614H78.2507C77.43 105.614 76.7646 104.95 76.7646 104.13C76.7646 103.31 77.43 102.646 78.2507 102.646H102.028V78.8978C102.028 78.0781 102.693 77.4136 103.514 77.4136C104.335 77.4136 105 78.0781 105 78.8978V104.13C105 104.95 104.335 105.614 103.514 105.614Z" fill="currentColor"></path>
                                    </svg></div>
                            </div>
                        </a>
                    </figure>
                    ...
                    <figure class="gallery_masonry-item col-sm-6 col-lg-4">
                        <a class="aspect aspect--sm" href="img/gallery/full02.jpg" data-role="gallery-link">
                            <div class="aspect__inner">
                                <picture>
                                    <img class="gallery_masonry-item_img lazy" data-src="img/gallery/full02.jpg" src="img/gallery/full02.jpg" alt="media">
                                </picture>
                            </div>
                            <div class="overlay d-flex align-items-center justify-content-center">
                                <div class="overlay_focus"><svg width="105" height="106" viewbox="0 0 105 106" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <figure class="gallery_masonry-item col-sm-6 col-lg-4">
                        <a class="aspect" href="img/gallery/full03.jpg" data-role="gallery-link">
                            <div class="aspect__inner">
                                <picture>
                                    <img class="gallery_masonry-item_img lazy" data-src="img/gallery/full03.jpg" src="img/gallery/full03.jpg" alt="media">
                                </picture>
                            </div>
                            <div class="overlay d-flex align-items-center justify-content-center">
                                <div class="overlay_focus"><svg width="105" height="106" viewbox="0 0 105 106" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <figure class="gallery_masonry-item col-sm-6 col-lg-4">
                        <a class="aspect" href="img/gallery/full05.jpg" data-role="gallery-link">
                            <div class="aspect__inner">
                                <picture>
                                    <img class="gallery_masonry-item_img lazy" data-src="img/gallery/full05.jpg" src="img/gallery/full05.jpg" alt="media">
                                </picture>
                            </div>
                            <div class="overlay d-flex align-items-center justify-content-center">
                                <div class="overlay_focus"><svg width="105" height="106" viewbox="0 0 105 106" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <figure class="gallery_masonry-item col-sm-6 col-lg-4">
                        <a class="aspect aspect--sm" href="img/gallery/full04.jpg" data-role="gallery-link">
                            <div class="aspect__inner">
                                <picture>
                                    <img class="gallery_masonry-item_img lazy" data-src="img/gallery/full04.jpg" src="img/gallery/full04.jpg" alt="media">
                                </picture>
                            </div>
                            <div class="overlay d-flex align-items-center justify-content-center">
                                <div class="overlay_focus"><svg width="105" height="106" viewbox="0 0 105 106" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <figure class="gallery_masonry-item col-sm-6 col-lg-4">
                        <a class="aspect aspect--sm" href="img/gallery/full06.jpg" data-role="gallery-link">
                            <div class="aspect__inner">
                                <picture>
                                    <img class="gallery_masonry-item_img lazy" data-src="img/gallery/full06.jpg" src="img/gallery/full06.jpg" alt="media">
                                </picture>
                            </div>
                            <div class="overlay d-flex align-items-center justify-content-center">
                                <div class="overlay_focus"><svg width="105" height="106" viewbox="0 0 105 106" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <figure class="gallery_masonry-item col-sm-6 col-lg-4">
                        <a class="aspect" href="img/gallery/full07.jpg" data-role="gallery-link">
                            <div class="aspect__inner">
                                <picture>
                                    <img class="gallery_masonry-item_img lazy" data-src="img/gallery/full07.jpg" src="img/gallery/full07.jpg" alt="media">
                                </picture>
                            </div>
                            <div class="overlay d-flex align-items-center justify-content-center">
                                <div class="overlay_focus"><svg width="105" height="106" viewbox="0 0 105 106" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <figure class="gallery_masonry-item col-sm-6 col-lg-4">
                        <a class="aspect aspect--sm" href="img/gallery/full08.jpg" data-role="gallery-link">
                            <div class="aspect__inner">
                                <picture>
                                    <img class="gallery_masonry-item_img lazy" data-src="img/gallery/full08.jpg" src="img/gallery/full08.jpg" alt="media">
                                </picture>
                            </div>
                            <div class="overlay d-flex align-items-center justify-content-center">
                                <div class="overlay_focus"><svg width="105" height="106" viewbox="0 0 105 106" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <figure class="gallery_masonry-item col-sm-6 col-lg-4">
                        <a class="aspect" href="img/gallery/full09.jpg" data-role="gallery-link">
                            <div class="aspect__inner">
                                <picture>
                                    <img class="gallery_masonry-item_img lazy" data-src="img/gallery/full09.jpg" src="img/gallery/full09.jpg" alt="media">
                                </picture>
                            </div>
                            <div class="overlay d-flex align-items-center justify-content-center">
                                <div class="overlay_focus"><svg width="105" height="106" viewbox="0 0 105 106" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <figure class="gallery_masonry-item col-sm-6 col-lg-4">
                        <a class="aspect" href="img/gallery/full11.jpg" data-role="gallery-link">
                            <div class="aspect__inner">
                                <picture>
                                    <img class="gallery_masonry-item_img lazy" data-src="img/gallery/full11.jpg" src="img/gallery/full11.jpg" alt="media">
                                </picture>
                            </div>
                            <div class="overlay d-flex align-items-center justify-content-center">
                                <div class="overlay_focus"><svg width="105" height="106" viewbox="0 0 105 106" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <figure class="gallery_masonry-item col-sm-6 col-lg-4">
                        <a class="aspect aspect--sm" href="img/gallery/full10.jpg" data-role="gallery-link">
                            <div class="aspect__inner">
                                <picture>
                                    <img class="gallery_masonry-item_img lazy" data-src="img/gallery/full10.jpg" src="img/gallery/full10.jpg" alt="media">
                                </picture>
                            </div>
                            <div class="overlay d-flex align-items-center justify-content-center">
                                <div class="overlay_focus"><svg width="105" height="106" viewbox="0 0 105 106" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <figure class="gallery_masonry-item col-sm-6 col-lg-4">
                        <a class="aspect aspect--sm" href="img/gallery/full12.jpg" data-role="gallery-link">
                            <div class="aspect__inner">
                                <picture>
                                    <img class="gallery_masonry-item_img lazy" data-src="img/gallery/full12.jpg" src="img/gallery/full12.jpg" alt="media">
                                </picture>
                            </div>
                            <div class="overlay d-flex align-items-center justify-content-center">
                                <div class="overlay_focus"><svg width="105" height="106" viewbox="0 0 105 106" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="footer_main d-sm-flex flex-wrap flex-lg-nowrap justify-content-between">
                <div class="footer_main-block footer_main-block--about col-sm-7 col-lg-auto d-flex flex-column">
                    ...
                    <p class="footer_main-block_text">
                        Seeking nearby rooms for couples? Find a romantic haven that offers privacy, comfort, and the
                        perfect ambiance for a special getaway.
                        Reserve your love nest now!
                    </p>
                </div>
